...
(function() {
    ...
    var basicBot = {
	    ...
	    launchTime: Date.now(),
            ...
            welcome: true,
            opLink: null,
            rulesLink: 'Leia a info da sala!',
            themeLink: "Livre",
            fbLink: "https://www.facebook.com/bondgartic/",
            youtubeLink: "https://www.youtube.com/channel/UCOckI-TZZrY8AZ5bUi6N3nQ",
            website: null,
            intervalMessages: [],
            messageInterval: 5,
            songstats: false,
            ...
            Tema02Command: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat('Tema Livre, todos os gêneros liberado!');
                    }
                }
            },
            ...
            Tema03Command: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat('Tema livre aproveite!');
                    }
                }
            },
